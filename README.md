...
Once the `conda-forge` channel has been enabled, `apeye` can be installed with:

```
conda install apeye
```

It is possible to list all of the versions of `apeye` available on your platform with:
